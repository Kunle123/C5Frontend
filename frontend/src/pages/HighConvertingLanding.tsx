...
const faqs = [
  ...
  {
    q: 'Is my data secure with Candidate 5?',
  ...
  {
    q: 'Can I edit the documents generated by Candidate 5?',
  ...
  return (
    <Box bg={bg} minH="100vh">
      ...
      <Flex direction={{ base: 'column', md: 'row' }} align="center" justify="space-between" px={{ base: 2, sm: 4, md: 16 }} py={{ base: 8, md: 16 }} bg="white">
        <VStack align="start" spacing={6} maxW={{ base: '100%', md: 'lg' }} w="100%">
          <Heading as="h1" textStyle="h1" fontSize={{ base: '2xl', sm: '3xl', md: '5xl' }} fontWeight="bold" color="navy">
            Stop Rewriting, Start Applying: Land Your Dream Job Faster with Candidate 5.
          </Heading>
          <Text fontSize={{ base: 'md', md: 'xl' }} color="slate">
            Tired of endless CV tweaks for every job? Candidate 5's AI uses your unique career history—your personal Career Arc™—to craft perfectly tailored CVs and cover letters in minutes, so you get noticed by employers.
          </Text>
      ...
      <Box py={{ base: 8, md: 16 }} px={{ base: 2, sm: 4, md: 16 }} textAlign="center">
        <Heading as="h2" textStyle="h2" fontSize={{ base: 'xl', md: '2xl', lg: '4xl' }} mb={4} color="navy">The Job Application Grind is Real. Candidate 5 is Your Way Out.</Heading>
      ...
      <Box id="how-it-works" py={{ base: 8, md: 16 }} px={{ base: 2, sm: 4, md: 16 }} bg="brand.50">
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={{ base: 6, md: 10 }}>
          ...
          <VStack align="center" spacing={4}>
            ...
            <Text color="slate">Find a job you love? Simply paste the job description into Candidate 5.</Text>
          </VStack>
          <VStack align="center" spacing={4}>
      ...
      {/* 6. Why Choose Candidate 5? */}
      <Box py={{ base: 8, md: 16 }} px={{ base: 2, sm: 4, md: 16 }}>
        <Heading as="h2" textStyle="h2" fontSize={{ base: '2xl', md: '4xl' }} mb={12} textAlign="center" color="navy">The Candidate 5 Advantage: More Than Just a CV Builder</Heading>
        <SimpleGrid columns={{ base: 1, md: 4 }} spacing={{ base: 6, md: 10 }}>
          <VStack align="center" spacing={4} bg={cardBg} p={6} borderRadius="md" boxShadow="md">
            ...
            <Text color="slate">Go beyond templates. Candidate 5 uses your unique Career Arc™ to create genuinely bespoke applications that reflect your true value.</Text>
          </VStack>
          <VStack align="center" spacing={4} bg={cardBg} p={6} borderRadius="md" boxShadow="md">
      ...
      <Box py={{ base: 8, md: 16 }} px={{ base: 2, sm: 4, md: 16 }} bgGradient="linear(to-r, brand.400, brand.600)">
        <VStack spacing={6} align="center" color="white">
          ...
          <Text fontSize={{ base: 'md', md: 'xl' }}>Stop letting tedious applications hold you back. Join Candidate 5 today and start applying smarter, faster, and with more confidence.</Text>
      ...
      <Box as="footer" py={8} px={{ base: 2, sm: 4, md: 16 }} bg={cardBg}>
        <Flex direction={{ base: 'column', md: 'row' }} justify="space-between" align="center" gap={4}>
          ...
          <Text fontSize="sm" color="slate">© {new Date().getFullYear()} Candidate 5. All Rights Reserved.</Text>
        </Flex>
      </Box>
    </Box>
  );
