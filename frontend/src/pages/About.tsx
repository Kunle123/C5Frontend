...
export default function About() {
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      <p className="mb-4">That's where the idea for Candidate 5 came from. I wanted to build a tool that could take what people already have; their real experience, skills, and achievements and turn it into a professional, tailored CV in minutes.</p>
      <p className="mb-4">Candidate 5 is designed to take the pain out of the process. It helps you create a CV and cover letter that not only looks great but actually works with the systems recruiters use.</p>
      <p className="mb-4">Because I've been there, I know how frustrating it can be. And I know how much of a difference the right CV can make.</p>
    </div>
  );
}
